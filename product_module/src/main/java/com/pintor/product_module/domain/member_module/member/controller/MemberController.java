package com.pintor.product_module.domain.member_module.member.controller;

import com.pintor.product_module.common.response.ResData;
import com.pintor.product_module.common.response.SuccessCode;
import com.pintor.product_module.common.service.MailService;
import com.pintor.product_module.domain.member_module.auth.service.AuthService;
import com.pintor.product_module.domain.member_module.member.entity.Member;
import com.pintor.product_module.domain.member_module.member.request.MemberPasswordResetRequest;
import com.pintor.product_module.domain.member_module.member.request.MemberPasswordUpdateRequest;
import com.pintor.product_module.domain.member_module.member.request.MemberProfileUpdateRequest;
import com.pintor.product_module.domain.member_module.member.request.MemberSignupRequest;
import com.pintor.product_module.domain.member_module.member.response.MemberPasswordResetResponse;
import com.pintor.product_module.domain.member_module.member.response.MemberSignupResponse;
